  ...
  const features = [
    {
      ...
      description:
        "Track student attendance digitally and monitor daily records in real time.",
    },
    {
      id: 2,
      ...
      description:
        "Manage school fees, track payments, and monitor outstanding balances easily.",
    },
    {
      id: 4,
      icon: <LuMessageSquare className="EEFIcons" />,
      title: "WhatsApp Parent toasts",
      description:
        "Send important updates, reminders, and announcements directly to parents instantly.",
    },
    {
      id: 5,
      ...
      description:
        "Allow parents to make secure school fee payments conveniently from anywhere.",
    },
  ];
      ...
      <section className="EEfeatures-container">
        <div className="EEfeatures-header">
          ...
          <h2 className="EEFtitle">
            ...
            <span className="EEFhighlight"> School Management</span>
          </h2>
          ...
          <div className="EELeftDownCont">
            ...
            <p className="EELeftDownContP">
              Organize and access student and staff
              <br />
