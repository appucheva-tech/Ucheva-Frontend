...
const AdminSubjects = () => {
  const subjectData = [
    { name: 'Mathematics', departments: 'General', section: 'All Sections', teachers: '8' },
    { name: 'English Language', departments: 'General', section: 'All Sections', teachers: '8' },
    { name: 'Civic Education', departments: 'General', section: 'PRY, JSS, SS', teachers: '7' },
    { name: 'Basic Science', departments: 'General', section: 'PRY, JSS, SS', teachers: '5' },
    { name: 'Chemistry', departments: 'Science', section: 'SS', teachers: '1' },
    { name: 'Further Maths', departments: 'Science', section: 'SS', teachers: '1' },
