...
const AdminClass = () => {
  const classData = [
    { name: 'SS 1A', section: 'Senior Secondary', teacher: 'Adaeze Clinton', students: '24' },
    { name: 'JSS 2C', section: 'Junior Secondary', teacher: 'Emeka Ugonna', students: '20' },
    { name: 'PRY 1', section: 'Primary', teacher: 'Tolu Adesunya', students: '15' },
    { name: 'NRY 2', section: 'Nursery', teacher: 'Chidi Okoronkwo', students: '18' },
    { name: 'SS 3B', section: 'Senior Secondary', teacher: 'Grace Obidi', students: '28' },
    { name: 'SS 2A', section: 'Senior Secondary', teacher: 'Ifeanyi Okafor', students: '28' },
    { name: 'JSS 1B', section: 'Junior Secondary', teacher: 'Ngozi Bassey', students: '22' }
  ];
  return (
    <>
    <header className="AdminDashboard-header">
      ...
      <div className="headerRow">
        <div>
          ...
          <p className="subtitle">Create classes, assign class teachers and manage class information.</p>
        </div>
